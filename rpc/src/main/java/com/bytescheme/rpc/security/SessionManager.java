...
/**
 * Session manager class. Sessions are expired in 5 minutes by default.
 * 
...
public class SessionManager {
  ...
  public void setSessionLifeTime(long sessionLifeTime) {
    Preconditions.checkArgument(sessionLifeTime > 1000L,
        "Session life time must be greater than one second");
  ...
  public Session addSessionId(Authentication authentication, String sessionId) {
    ...
    Session session = new Session(authentication, sessionId,
