...
public class VideoUrlTest {
  ...
  public void testGetVideoUrl() throws Exception {
    ...
    RemoteObjectClient client = clientBuilder.login("controlboard",
        CryptoUtils.encrypt("controlboard", CryptoUtils.getPublicKey(
            "src/test/resources/bfd8dd0a-10db-4782-86ec-b27f52d6362c.pub")));
